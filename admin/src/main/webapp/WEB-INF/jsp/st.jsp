...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function pageCallback(index, jq) {
            ...
            // TODO
            var url = "article?type=st&page=" + index + "&asc=${page.asc}&keyword=${page.keyword}";
                ...
                <div class="col-lg-3 col-lg-offset-1 col-xs-3"
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <!-- TODO -->
                                <a href="article?type=st&page=0&asc=false&keyword=${page.keyword}">ID 降序</a></li>
                            <li>
                                <!-- TODO -->
                                <a href="article?type=st&page=0&asc=true&keyword=${page.keyword}">ID 升序</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    $(function () {
        // TODO
        $("#st-menu").addClass("meun-item-active");

        $("#searchBtn").click(function () {
            // TODO
            var url = "article?type=st&page=0&asc=${page.asc}&keyword=" + $("#keyword").val();
            window.location.href = url;
        });
