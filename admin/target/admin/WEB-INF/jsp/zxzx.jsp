...
<script type="text/javascript">
    ...
    $(function () {
        ...
        function pageCallback(index, jq) {
            ...
            // TODO
            var url = "article?type=zxzx&page=" + index + "&asc=${page.asc}&keyword=${page.keyword}";
        ...
        <div role="tabpanel" class="tab-pane" id="zxzx">
                ...
                <div class="col-lg-3 col-lg-offset-1 col-xs-3"
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            <li>
                                <!-- TODO -->
                                <a href="article?type=zxzx&page=0&asc=false&keyword=${page.keyword}">ID 降序</a></li>
                            <li>
                                <!-- TODO -->
                                <a href="article?type=zxzx&page=0&asc=true&keyword=${page.keyword}">ID 升序</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="data-div">
                <div class="row tableHeader">
                    ...
                    <div class="col-xs-1">作者</div>
                    <div class="col-xs-1">日期</div>
                    <div class="col-xs-1">简介</div>
                    <div class="col-xs-1">链接</div>
                ...
                <div class="tablebody">
                    <c:forEach var="entry" items="${page.list}" begin="0" end="${fn:length(page.list)}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-1">${entry.author}</div>
                            <div class="col-xs-1">${entry.date}</div>
                            <div class="col-xs-1">
                            ...
                            <div class="col-xs-1">
                                <a class="linkCcc" href="${entry.url}">
                                    <c:choose>
                                        <c:when test="${fn:length(entry.url) < 18}">${entry.url}</c:when>
                                        <c:otherwise>${fn:substring(entry.url, 0, 18)}...</c:otherwise>
                                    </c:choose>
                                </a>
                            </div>
                            <div class="col-xs-1">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <form class="form-horizontal" id="addForm">
                                    ...
                                    <div class="form-group">
                                        <label for="author" class="col-xs-3 control-label">作者：</label>
                                        <div class="col-xs-9">
                                    ...
                                    <div class="form-group">
                                        <label for="date" class="col-xs-3 control-label">日期：</label>
                                        <div class="col-xs-9">
                        ...
                        <div class="modal-body">
                            <div class="container-fluid">
                                <form class="form-horizontal" id="updateForm">
                                    ...
                                    <div class="form-group">
                                        <label for="author2" class="col-xs-3 control-label">作者：</label>
                                        <div class="col-xs-9">
                                            <input name="author2" id="author2" type="text"
                                                   class="form-control input-sm duiqi">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="date2" class="col-xs-3 control-label">日期：</label>
                                        <div class="col-xs-9">
...
<script type="text/javascript">
    $(function () {
        // TODO
        $("#zxzx-menu").addClass("meun-item-active");

        $("#searchBtn").click(function () {
            // TODO
            var url = "article?type=zxzx&page=0&asc=${page.asc}&keyword=" + $("#keyword").val();
            window.location.href = url;
        });
